...
export const ManageRoles = () => {
    ...
    const tableColumns = [
        ...
        {
            title: t('permissions.tableColumns.users'),
            dataIndex: 'users',
            key: 'users',
    ...
    return (
        <PageContainer>
            ...
            {rolesLoading && !rolesData && (
                <Message type="loading" content={t('permissions.loadingRoles')} style={{ marginTop: '10%' }} />
            )}
            ...
            <SourceContainer>
                <TabToolbar>
                    ...
                    <SearchBar
                        initialQuery={query || ''}
                        placeholderText={t('permissions.searchRoles')}
                        hideRecommendations
                        suggestions={[]}
                        style={{
                            maxWidth: 220,
                    ...
                    {isBatchAddRolesModalVisible && (
                        <SearchSelectModal
                            titleText={t('permissions.assignRoleToUsersModal', { role: focusRole?.name })}
                            continueText={t('permissions.add')}
