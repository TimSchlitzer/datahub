...
export const UserList = () => {
    ...
    return (
        <>
            ...
            {!usersData && loading && <Message type="loading" content={t('identity.user.loadingUsers')} />}
            ...
            <UserContainer>
                <TabToolbar>
                    <div>
                        ...
                        >
                            <UsergroupAddOutlined /> {t('identity.user.inviteUsers')}
                        </Button>
                    </div>
                    <SearchBar
                        initialQuery={query || ''}
                        placeholderText={t('identity.user.searchUsersPlaceholder')}
                        suggestions={[]}
                        style={{
                            maxWidth: 220,
                            padding: 0,
