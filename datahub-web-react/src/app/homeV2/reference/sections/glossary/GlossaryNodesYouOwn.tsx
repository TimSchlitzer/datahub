    ...
    return (
        <ReferenceSection>
            <EntityLinkList
                ...
                title={t('home.reference.glossary.title')}
                tip={t('home.reference.glossary.subtitle')}
            ...
            {showModal && (
                <EmbeddedListSearchModal
                    title={t('home.reference.glossary.titleAlt')}
                    fixedFilters={{
                    ...
                    placeholderText={t('home.reference.glossary.filter')}
                />
            )}
        </ReferenceSection>
    );
